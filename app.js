...
const i18n = {
    ja: {
        ...
        transcribe_app_title: "Gemini 3.5 文字起こし・翻訳 & 話者分離",
        transcribe_app_desc: "Gemini 3.5 Transcribe Live による低遅延リアルタイム文字起こし＆文脈考慮Flash-Lite翻訳。録音後は話者分離＆3.8 Flash議事録要約。",
        ...
        torque_presets_notice: "【ご注意】上記数値は代表的な参考目安です。締め付けトルクは車種・年式・素材・メーカー指定等により大きく異なります。実際の作業時は必ず対象機器・車両の<strong>取扱説明書やサービスマニュアルに記載された規定トルクに従ってください</strong>。",
    ...
    en: {
        ...
        transcribe_app_title: "Gemini 3.5 Real-time Transcribe, Translate & Diarization",
        transcribe_app_desc: "Real-time low-latency transcription via Gemini 3.5 Transcribe Live & context-aware Flash-Lite translation. Post-meeting speaker diarization & 3.8 Flash summary.",
        oklab_app_title: "OKLab Tone Curve & Photo Retouch",
        ...
        torque_presets_notice: "<strong>Caution:</strong> The values above are general reference estimates only. Tightening specifications vary widely by manufacturer, vehicle model, fastener grade, and materials. Always <strong>follow the manufacturer's instruction manual or official service manual</strong>.",
    ...
    es: {
        ...
        transcribe_app_title: "Gemini 3.5 Transcripción, Traducción y Diarización",
        transcribe_app_desc: "Transcripción de baja latencia en tiempo real con Gemini 3.5 Transcribe Live y traducción contextual Flash-Lite. Diarización de hablantes y resumen con 3.8 Flash.",
        oklab_app_title: "OKLab Tone Curve & Photo Retouch",
        ...
        torque_presets_notice: "<strong>Atención:</strong> Los valores anteriores son solo referencias generales. Las especificaciones de par varían ampliamente según el fabricante, modelo, grado y materiales. Siempre <strong>consulte y siga las especificaciones del manual de instrucciones o servicio técnico oficial</strong>.",
